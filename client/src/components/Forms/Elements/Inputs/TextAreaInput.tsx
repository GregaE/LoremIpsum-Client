  ...
  return (
    <div className="w-full flex flex-col mt-8">
      ...
      <textarea
        ...
        {...props}
        className="w-full leading-none text-dark p-3 mt-4 bg-primary-bg border-primary-bg rounded focus:outline-none focus:border focus:ring-2 focus:ring-primary leading-tight"
