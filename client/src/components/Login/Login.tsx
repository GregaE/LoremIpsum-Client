          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div>
              <button
                onClick={() => dispatch(toggleLogin())}
                type="submit"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-light bg-primary hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
