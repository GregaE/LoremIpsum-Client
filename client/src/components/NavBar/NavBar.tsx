...
function NavBar({ navigate }: any) {
  const white =
    'invert(100%) sepia(94%) saturate(0%) hue-rotate(193deg) brightness(105%) contrast(108%)';
  const orange =
    'invert(73%) sepia(22%) saturate(6069%) hue-rotate(355deg) brightness(94%) contrast(97%)';
      ...
      <div className="w-4/6 h-1/6 m-5 flex justify-center">
        <Link to="/">
          <img
            ...
            style={{ objectFit: 'contain', filter: `${logoColor}` }}
            className="h-48"
