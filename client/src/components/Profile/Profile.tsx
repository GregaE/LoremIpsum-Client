      ...
      <div className="flex flex-row justify-center ml-5 h-auto pb-10">
        ...
        <div className="w-2/3 h-full flex flex-col w-auto p-4 h-1/6 m-5 justify-center bg-primary rounded-lg">
          <div className="h-10 w-full px-4 py-2 text-2xl flex justify-around">
            <p className="h-full w-full text-light">
            ...
            <AnimatePresence exitBeforeEnter>
              {!editFlag && (
                ...
                >
                  ...
                  <p>E-mail: {personal_details.email}</p>
                  <p>Phone: {personal_details.phone_number}</p>
                  <p>
                    Address: {personal_details.street}, {personal_details.city},{' '}
                    {personal_details.postcode} {personal_details.country}
                  </p>
                  <br />
                  <p>Description: {personal_details.headline}</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
